...
export interface FreeTextConfig {
  acceptable_answers: string[];       // 許容される回答のリスト
  matching_mode: MatchingMode;        // マッチングモード
  case_sensitive?: boolean;           // 大文字小文字を区別するか
  trim_whitespace?: boolean;          // 前後の空白を無視するか
...
export interface FreeTextQuestion extends BaseQuestion {
  ...
  choices?: Choice[]; // 自由記述の場合、choicesは使わない
  correct_answers: FreeTextAnswer[];
  images?: QuestionImage[];
}
