      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full h-20 p-3 border-2 border-[#95A5A6] rounded-lg text-[#2C3E50] bg-white font-medium"
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex-1 bg-[#27AE60] hover:bg-[#229954] text-white font-bold py-3 px-6 rounded-lg transition-colors disabled:opacity-50"
                >
                  {saving ? '保存中...' : '💾 保存'}
                </button>
                <button
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            <p className="text-[#2C3E50] font-bold mb-4">
            ...
            {questions.map((question) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-[#2C3E50] font-bold mb-3">
                  ...
                  <div className="space-y-1 mb-3">
                    {question.choices
                      ...
                      .map((choice) => (
                        <div
                          key={choice.id}
                          className={`p-2 rounded text-[#2C3E50] font-medium ${
                            choice.is_correct
                              ? 'bg-green-100 border-2 border-green-500'
